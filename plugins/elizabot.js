...
function ElizaBot(rules, noRandomFlag) {
	if (!rules) {
		rules = "./elizadata.js";
	}
	var ruleSet = require(rules);
	this.elizaInitials = ruleSet.initials;
	this.elizaFinals = ruleSet.finals;
	this.elizaQuits = ruleSet.quits;
	this.elizaPres = ruleSet.pres;
	this.elizaPosts = ruleSet.posts;
	this.elizaRawSynons = ruleSet.synons;
	this.elizaRawKeywords = ruleSet.keywords;	 
	this.elizaPostTransforms = ruleSet.postTransforms;
	this.elizaName = ruleSet.name;
...
ElizaBot.prototype.elizaInitials;
ElizaBot.prototype.elizaFinals;
ElizaBot.prototype.elizaQuits;
ElizaBot.prototype.elizaPres;
ElizaBot.prototype.elizaPosts;
ElizaBot.prototype.elizaRawSynons;
ElizaBot.prototype.elizaSynons;
ElizaBot.prototype.elizaRawKeywords;
ElizaBot.prototype.elizaKeywords;
// regexp/replacement pairs to be performed as final cleanings
// here: cleanings for multiple bots talking to each other
ElizaBot.prototype.elizaPostTransforms;
ElizaBot.prototype.elizaName;

ElizaBot.prototype.name = function() {
	return this.elizaName;
}
...
ElizaBot.prototype._init = function() {
	// Since we change the sysons and keywords, we want to operate on a copy of the data file
	this.elizaSynons = JSON.parse(JSON.stringify( this.elizaRawSynons ));
	this.elizaKeywords = JSON.parse(JSON.stringify( this.elizaRawKeywords ));
    ...
    // check for this.elizaQuits and install default if missing
...
ElizaBot.prototype.getFinal = function() {
    return this.elizaFinals[Math.floor(Math.random() * this.elizaFinals.length)].replace(" ?", "?");
}

ElizaBot.prototype.getInitial = function() {
    return this.elizaInitials[Math.floor(Math.random() * this.elizaInitials.length)].replace(" ?", "?");
}
