...
function DiceRoller() {
    ...
    this.roll = function(notation) {
        ...
        if(notation){
            diceRoll = new DiceRoll(notation, lib);
    ...
    */
    this.notationPatterns = new function(){
        var strings = {
          /**
    ...
    */
    this.parseNotation    = function(notation){
        ...
        if(notation){
          ...
          var match;
          while((match = lib.notationPatterns.get('notation', 'g').exec(notation)) !== null){
            var die = {
            ...
            if(typeof die.sides === 'string'){
              die.fudge = die.sides.match(lib.notationPatterns.get('fudge', null, true)) || false;
            }
            ...
            if(match[10]){
              ...
              var additionMatch;
              while((additionMatch = lib.notationPatterns.get('addition', 'g').exec(match[10]))){
    ...
    */
    this.parseDie         = function(notation){
...
* @constructor
*/
function DiceRoll(notation, roller) {
    // Constructor
    var lib = this;
    var rollerLib = roller;
    ...
    var init          = function(notation){
      ...
      // parse the notation
      parsedDice = rollerLib.parseNotation(notation);
